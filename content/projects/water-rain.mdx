...
I learned the basics of how not to structure and architect code. How I should have designed my code to support serialization and netcode. I also learned the importance of having an art pipeline to automate many tasks while improving art quality. Though it was a failure in many ways, it was f*cking fun and it was what started my journey.
